...
def block_to_block_type(block):
    ...
    if block.startswith(">"):
        for line in lines:
            if not line.lstrip().startswith(">"):  # Use lstrip to ignore leading spaces
...
def markdown_to_html_node(markdown):
    ...
    for block in blocks:
        ...
        print(f'Block: {block}')  # Debug: print each block
        print(f'Block Type: {block_type}')  # Debug: print determined block type
